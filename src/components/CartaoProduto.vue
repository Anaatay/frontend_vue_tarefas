    ...
    <div class="card h-100 shadow-sm">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <button class="btn btn-outline-primary btn-sm me-2" @click="$emit('visualizar', produto)">
                        <i class="fas fa-eye"></i>
                    </button>

                    <button class="btn btn-primary btn-sm" :disabled="produto.estoque === 0" @click="adicionarCarrinho">
