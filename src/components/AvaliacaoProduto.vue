<template>
    <div class="avaliacao-produto card">
        <div class="card-header bg-warning text-dark d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-sm btn-outline-dark ms-2" style="font-weight:bold;" @click="$emit('fechar')"
                title="Fechar avaliação">-</button>
        </div>
        <div class="card-body">
                    ...
                    <div>
                        ...
                        <div class="estrelas-display">
                            <i v-for="n in 5" :key="n" class="fas fa-star"
                                :class="n <= mediaAvaliacoes ? 'text-warning' : 'text-muted'"></i>
            ...
            <div class="nova-avaliacao mb-4">
                ...
                <div class="mb-3">
                    ...
                    <div class="estrelas-input">
                        <i v-for="n in 5" :key="n" class="fas fa-star fa-2x"
                            ...
                            @click="novaAvaliacao.nota = n" @mouseenter="notaHover = n" @mouseleave="notaHover = 0"
                ...
                <div class="mb-3">
                    ...
                    <input v-model="novaAvaliacao.nome" type="text" class="form-control" placeholder="Seu nome"
                        required>
                </div>

                <div class="mb-3">
                    <label class="form-label">Comentário (opcional):</label>
                    <textarea v-model="novaAvaliacao.comentario" class="form-control" rows="3"
                        placeholder="Conte-nos sobre sua experiência..."></textarea>
                </div>

                <button @click="adicionarAvaliacao" class="btn btn-warning w-100"
                    ...
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            ...
                            <div class="estrelas-pequenas">
                                <i v-for="n in 5" :key="n" class="fas fa-star fa-sm"
                                    :class="n <= avaliacao.nota ? 'text-warning' : 'text-muted'"></i>
                            </div>
                        </div>
