    ...
    <div class="lista-produtos">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex gap-2">
                ...
                <input v-model="pesquisa" type="text" class="form-control" placeholder="Pesquisar produtos...">
            </div>
        </div>

        <div class="row">
            <div v-for="produto in produtosFiltrados" :key="produto.id" class="col-lg-4 col-md-6 mb-4">
                <CartaoProduto :produto="produto" @adicionar-carrinho="adicionarAoCarrinho"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button @click="adicionarAoCarrinho(produtoSelecionado)" class="btn btn-primary"
